...
// Arreglar este codigo en el CSS
    return "<div class=\"cont-slots-pr\">" +
        ...
        "<div><p>Tamaño rueda: </p><p>" + tamano + "</p><p>IN</p></div>" +
        "<div><p>Precio:</p><p> $" + precio + " </p><p>USD</p><div><button id=\"button-slots-pr-1\"></button><button id=\"button-slots-pr-2\"></button></div></div>" +
